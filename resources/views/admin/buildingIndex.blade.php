...
@section('content')
    ...
    <section class="w-full p-4 md:p-0 md:w-3/4">
            ...
            <div class="mx-auto max-w-screen-xl bg-white shadow-md rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        <div
                            ...
                            <button type="button" data-modal-target="addBuildingModal" data-modal-toggle="addBuildingModal"
                ...
                <div class="relative overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-4">Jumlah Kamar Hunian</th>
                        ...
                        @foreach ($buildings as $building)
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-3">{{ $building->rooms->count() }} Kamar</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <ul class="py-1 text-sm flex">
                                        <li>
                                            <button type="button" data-modal-target="deleteBuildingModal"
                                                    data-modal-toggle="deleteBuildingModal"
        ...
        {{-- MODAL BOX ADD --}}
        <div id="addBuildingModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
                    ...
                    <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5">
                        ...
                        <button type="button"
                                ...
                                data-modal-toggle="addBuildingModal">
                            <i class="fa-solid fa-xmark"></i>
                        </button>
                    </div>
                    <!-- Modal body -->
                    <form id="addBuildingForm" method="POST" action="/api/buildings">
                        @csrf
        ...
        <!-- Delete modal -->
        <div id="deleteBuildingModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <!-- Modal content -->
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    <button type="button" class="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="deleteBuildingModal">
                        <i class="fa-solid fa-xmark"></i>
                    </button>
    ...
    <script>
        ...
        Array.from(deleteBtns).forEach(function(btn) {
            btn.addEventListener('click', function() {
                ...
                const form = document.getElementById('deleteBuildingForm');
                form.action = `/api/buildings/${id}`
            })
        })
    </script>
